...
public class Ticketing {
    ...
    public static String getTicket(int age, boolean isBoy) {
        if (age >= 0 && age <= 5) {                 //predicate 1
            return "Rhymes Competition";
        }
        if (age > 5 && age <= 10 && isBoy) {        //predicate 2
            return "Storytelling";
        }
        if (age > 5 && age <= 10 && !isBoy) {       //predicate 3
            return "Drawing Competition";
        }
        if (age > 10 && age <= 15 && isBoy) {       //predicate 4
            return "Quiz";
        }
        if (age > 10 && age <= 15 && !isBoy) {      //predicate 5
            return "Essay writing";
        }
        if (age > 15) {                             //predicate 6
